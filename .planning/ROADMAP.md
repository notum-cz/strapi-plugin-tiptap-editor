...
- [x] **Phase 5: Image Insertion** — Full insert flow: Media Library picker, alt text prefill and editing, asset ID storage, image visible in editor (completed 2026-03-16)
